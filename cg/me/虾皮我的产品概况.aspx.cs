...
{
    public partial class 虾皮我的产品概况 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (uid != "6" && uid != "9" && uid != "8" && uid != "16" && uid != "11" && uid != "13" && uid != "17" && uid != "18" && uid != "19")
                {
                ...
                if (Request.QueryString["txtsjbm"] != null && Request.QueryString["txtsjbm"] != "")
                {
                    ...
                    if (Session["dtall"] != null)
                    {
                        ...
                        lify.Text = "当前<span style='color:red'>" + pageindex + "</span>共" + pg + "页";
                        for (int i = 1; i <= pg; i++)
                        {
                        ...
                        {
                            if (Request.QueryString["order"] == "GroupName")
                            {
                                order = "分组排序";
                            }
                            if (Request.QueryString["order"] == "BName")
                            {
                                order = "店铺名称排序";
                            }
        ...
        public void bindzhy()
        {
            ...
            rplb.DataSource = null;
            rplb.DataBind();
            string where = " bid in(select browserid from houtai where browserid <>'' and is_close=0 ) and ";
            bool kycx = true;
            if (Request.QueryString["txtsjbm"] != null && Request.QueryString["txtsjbm"] != "")
            {
            ...
            if (Request.QueryString["order"] != null && Request.QueryString["order"] != "")
            {
                ...
                if(Request.QueryString["order"]== "live")
                {
                    order = " live asc";
                }
            }
            ...
            string sqler = "select * from ShopeeListCount where " + where + " order by " + order;
            string oldslq = "";
