<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="广东发出信息登记.aspx.cs" Inherits="WebApplication11.cg.广东发出信息登记" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <div>
                <h3>当前页面【<span style="color: crimson">广东发出信息登记</span>】</h3>
            ...
            <div>
                ...
                中文或者印尼语标题：<asp:TextBox ID="txttitle" runat="server"></asp:TextBox>&nbsp;
                 莆田发出单号：<asp:TextBox ID="txtputianfachudanhao" runat="server"></asp:TextBox>&nbsp;
                排序：<asp:DropDownList ID="dporder" runat="server">
                    <asp:ListItem Value="putianfachudanhao">莆田发出单号</asp:ListItem>
                    <asp:ListItem Value="putianfachubeizhu">莆田发出备注</asp:ListItem>
                    <asp:ListItem Value="putianfachuriqi">莆田发出日期</asp:ListItem>
                    <asp:ListItem Value="guangdongfachudanhao">广东发出单号</asp:ListItem>
                </asp:DropDownList>&nbsp;
                        ...
                        <tr>
                            ...
                            <td>
                                <table class="ttta">
                                    ...
                                    <tr>
                                        <td style="width: 30%" class="bbb">广东发出日期<span style="color: red">(*)</span></td>
                                        <td>
                                            <asp:TextBox ID="txtguangdongfachuriqi" Text='<%# Eval("guangdongfachuriqi") %>' Width="80%" runat="server"></asp:TextBox>
                                        </td>

                                    </tr>
                                    <tr>
                                        <td style="width: 30%" class="bbb">广东发出单号<span style="color: red">(*)</span></td>
                                        <td>
                                            <asp:TextBox ID="txtguangdongfachudanhao" Text='<%# Eval("guangdongfachudanhao") %>' Width="80%" runat="server"></asp:TextBox>
                                        </td>

                                    </tr>
                                    <tr>
                                        <td style="width: 30%" class="bbb">广东物流类型<span style="color: red">(*)</span></td>
                                        <td>
                                            <asp:TextBox ID="txtguangdongwuliuleixing" Text='<%# Eval("guangdongwuliuleixing") %>' Width="80%" runat="server"></asp:TextBox>
                                        </td>

                                    </tr>
                                    <tr>
                                        <td style="width: 30%" class="bbb">海外仓入库单号<span style="color: red">(*)</span></td>
                                        <td>
                                            <asp:TextBox ID="txthaiwaicangrukudanhao" Text='<%# Eval("haiwaicangrukudanhao") %>' Width="80%" runat="server"></asp:TextBox>
                                        </td>
