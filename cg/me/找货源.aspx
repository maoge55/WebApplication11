<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="找货源.aspx.cs" Inherits="WebApplication11.cg.找货源" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <div>
                <h3>当前页面【<span style="color: #37cbc5">找货源</span>】</h3>
                                ...
                                <table class="ttta">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <asp:LinkButton ID="LinkButton2" OnClientClick="JavaScript:return confirm('确定拉黑该产品？');" runat="server" Text="拉黑该产品" ForeColor="White" BackColor="Black" CssClass="butt" CommandName="bc" CommandArgument='<%# Eval("id") %>' />
                                    </tr>
                                </table>
