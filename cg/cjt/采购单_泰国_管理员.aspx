<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="采购单_泰国_管理员.aspx.cs" Inherits="WebApplication11.cg.cjt.采购单_泰国_管理员" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div>
                <h3>当前页面【<span style="color: #37cbc5">采购单_泰国_管理员</span>】</h3>
            ...
            &nbsp;
                ...
                <asp:DropDownList ID="ddlStatus" runat="server" CssClass="status-filter">
                    ...
                    <asp:ListItem Value="是">是</asp:ListItem>
                     <asp:ListItem Value="不发仓">不发仓</asp:ListItem>
                    <asp:ListItem Value="-1">全部状态</asp:ListItem>
                </asp:DropDownList>
                 最小订单数量：
                <asp:TextBox ID="txtMinOrderCount" runat="server" TextMode="Number" min="0"></asp:TextBox>
                 &nbsp;
                 采购单状态：
                <asp:DropDownList ID="ddlcaiguo" runat="server" CssClass="status-filter">
                            ...
                            <td>
                                <table class="ttta">
                                   <tr>
                                        ...
                                        <td><a href="<%# Eval("产品链接") %>" target="_blank">打开网址</a>&nbsp;&nbsp;
                                            <input type="text" value='<%# Eval("产品链接") %>' style="width: 20px" id="url<%# Container.ItemIndex+1 %>" />
                                   ...
                                   <tr>
                                        <td style="width: 30%" class="bbb">销售链接SKU</td>
                                        <td><%# Eval("销售链接SKU") %></td>
                                    </tr>

                                   <tr>
                                        <td style="width: 30%" class="bbb">SKU订单数量</td>
                                        <td><%# Eval("订单总数") %></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<%# Eval("1688采购链接") %>" target="_blank">打开网址</a>&nbsp;&nbsp;
                                            <input type="text" value='<%# Eval("1688采购链接") %>' style="width: 20px" id="url1<%# Container.ItemIndex+1 %>" />
                                            <input type="button" class="anniu1" onclick='copyUrl("url<%# Container.ItemIndex+1 %>")' value="复制网址">
                                            <asp:Literal ID="URL" runat="server" Text='<%# Eval("1688采购链接") %>' Visible="false"/>
                                         </td>
                                ...
                                <tr>
                                    ...
                                    <td><%# Eval("需采购数量") %><asp:TextBox ID="taiguoxucaigoushuliang" runat="server" Text=' <%# Eval("需采购数量") %>'></asp:TextBox></td>
                                       ...
                                       <td>
                                           <asp:TextBox ID="taiguocaigoudanhao" runat="server" 
    Text='<%# Eval("采购单号") as string ?? "" %>' />
                                        </td>
                                    </tr>
                                     ...
                                     <tr>
                                        <td style="width: 30%" class="bbb">上架到泰国虾皮</td>
                                        <td>
                                            <div style="display: flex; align-items: center; gap: 10px;">
                                                <asp:DropDownList 
                                                        ID="shangjiataiguo" 
