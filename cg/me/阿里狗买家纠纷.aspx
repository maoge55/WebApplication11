<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="阿里狗买家纠纷.aspx.cs" Inherits="WebApplication11.cg.阿里狗买家纠纷" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <div>
                <h3>当前页面【<span style="color: #cba537">阿里狗买家纠纷</span>】
                ...
                <asp:Repeater ID="rplb" runat="server" OnItemCommand="rplb_ItemCommand">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="text-align: center">
                                <%# Eval("order_offers_0_id")%>
                            </td>
                            <td style="text-align: center">
                                <%# Eval("order_offers_0_name")%>
                            </td>
                            <td style="text-align: center">OPEN
                            </td>
                            <td style="text-align: center">
                                <%# Eval("update_time")%>
                            </td>
