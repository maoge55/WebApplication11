<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="clogin.aspx.cs" Inherits="WebApplication11.clogin" %>
...
<body>
    <form id="form1" runat="server">
        <div class="main">
            <div style="background-color: #dfc097;">
                <div class="ts">
                    <p>
                        <asp:Literal runat="server" ID="lits" Text="CG"></asp:Literal>
                    </p>
                </div>
