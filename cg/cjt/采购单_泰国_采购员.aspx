<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="采购单_泰国_采购员.aspx.cs" Inherits="WebApplication11.cg.cjt.采购单_泰国_采购员" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div>
                <h3>当前页面【<span style="color: #37cbc5">采购单_泰国_采购员</span>】</h3>
                           ...
                           <img src='<%# Eval("SKU图片")%>' style="width:300px" /> 
                            ...
                            <td>
                                <table class="ttta">
                                    ...
                                    <tr>
                                        <td style="width: 30%" class="bbb">shopee产品链接</td>
                                        <td><a href="<%# Eval("shopee产品链接") %>" target="_blank">打开网址</a>&nbsp;&nbsp;
                                            <input type="text" value='<%# Eval("shopee产品链接") %>' style="width: 20px" id="shopeeurl<%# Container.ItemIndex+1 %>" />
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<%# Eval("1688产品链接") %>" target="_blank">打开网址</a>&nbsp;&nbsp;
                                            <asp:TextBox ID="url" runat="server" Text='<%# Eval("1688产品链接") %>'> </asp:TextBox>
                                            <input type="button" class="anniu1" onclick='copyUrl("url<%# Container.ItemIndex+1 %>")' value="复制网址">
                                         </td>
